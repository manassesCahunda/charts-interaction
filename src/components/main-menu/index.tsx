"use client";
import { updateMenuAction } from "@/hooks/action";
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    isCustomizing && "animate-[jiggle_0.3s_ease-in-out_infinite] transform-gpu pointer-events-none",
                  )}
                >
                  <Icon />
...
export function MainMenu({ initialItems, onSelect }: Props) {
  ...
  return (
    <div className="mt-6" {...bind()} ref={menuRef}>
      <nav>
        <Reorder.Group
          axis="y"
          onReorder={onReorder}
